...
describe('highlightHtml', () => {
  ...
  it('highlights a python block with shiki tokens', { timeout: 20000 }, async () => {
  ...
  it('strips existing highlight.js spans before re-highlighting', { timeout: 20000 }, async () => {
  ...
  it('falls back to plaintext for unknown languages', { timeout: 20000 }, async () => {
  ...
  it('returns empty string for missing html', async () => {
